...
<body>
  <div class="container-fluid" id="wrapper">
    <div class="panel panel-primary hidden-xs">
      <div class="panel-heading" style="background-color: #3b8dbc;border-color: #3b8dbc;">
        <h1 class="panel-title">Trình quản lý tập tin</h1>
      </div>
    </div>
    <div class="row">
    ...
    Dropzone.options.uploadForm = {
      ...
      init: function() {
        ...
        this.on('success', function(response) {
          var status = response.xhr.response;
          if (status == 'OK') {
